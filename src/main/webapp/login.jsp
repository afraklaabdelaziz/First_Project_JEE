        ...
        <div>
            <form action="#" method="post">
                ...
                <div class="grid grid-cols-2 gap-4 my-5 mx-8">
                    ...
                    <input type="email" value="${email}"   name="email" class="w-full p-1 border-2 placeholder-blue-800 border-blue-700 appearance-none rounded-lg focus:outline-none focus:ring-2">

                    <label class="text-xl flex items-center">password :</label>
                    <input type="password" value="${password}"  name="password" class="w-full p-1 border-2 placeholder-blue-800 border-blue-700 appearance-none rounded-lg focus:outline-none focus:ring-2">
