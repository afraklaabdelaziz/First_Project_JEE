...
<div>
    <div class="bg-white mx-auto text-center w-1/2 py-5 shadow-xl rounded-3xl">
        <h2 class="text-4xl font-semibold border-b pb-2 mx-6">Register</h2>
        ...
        <div>
            <form method="post">
                ...
                <div class="grid grid-cols-2 gap-4 my-5 mx-8">
                    ...
                    <label class="text-xl flex items-center">First name :</label>
                    <input type="text"  name="fname" class="w-full p-1 border-2 placeholder-blue-800 border-blue-700 appearance-none rounded-lg focus:outline-none focus:ring-2">

                    <label class="text-xl flex items-center">Last name :</label>
                    <input type="text"  name="lname" class="w-full p-1 border-2 placeholder-blue-800 border-blue-700 appearance-none rounded-lg focus:outline-none focus:ring-2">
                    ...
                    <label class="text-xl flex items-center">Phone :</label>
                    <input type="text"  name="phone" class="w-full p-1 border-2 placeholder-blue-800 border-blue-700 appearance-none rounded-lg focus:outline-none focus:ring-2">
